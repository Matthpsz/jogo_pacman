...
#resolução total da tela.
screen = pygame.display.set_mode((800, 600), 0)

#font
font = pygame.font.SysFont("arial", 20, True, False)

#cores usadas no game
AMARELO = (255, 255, 0)
PRETO = (0, 0 , 0)
AZUL = (0, 0 , 255)
VELOCIDADE = 1
...
class Pacman:
    ...
    #adição e subtração de velocidade do pacman diante das bordas laterais.
    def calcular_regras(self):
...
if __name__ == "__main__":
    ...
    #pintar a tela. (plano de fundo/limpeza para o looping)
        screen.fill(PRETO)
